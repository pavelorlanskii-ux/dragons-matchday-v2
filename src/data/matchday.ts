...
export const matchday = {
  ...
  activities: [
    ...
    },
    {
      ...
      description: "Вопросы, эмоции и подарки победителям. Участвовать просто: слушайте ведущего и включайтесь ��месте с сектором.",
  ...
  offers: [
    {
      id: "family",
      title: "Скидка до 30% для владельцев абонементов",
      badge: "Для болельщиков",
      description:
        "Матч включен в сезонный абонемент. Для их владельцев при покупке дополнительных билетов предусмотрена скидка: 20% - билеты с доступом к ресторанам, 30% - остальные билеты.",
      link: { label: "Купить билеты", href: "#tickets" },
    },
    {
      id: "kids",
      title: "Детские билеты по 100 рублей",
      badge: "С детьми",
      description:
        "Стоимость детских билетов на все сектора составляет 100 рублей, за исключением Бизнес-клубов.",
      link: { label: "Купить билеты", href: "#tickets" },
    },
    {
      id: "loyalty",
      title: "Скидка 10% для программы лояльности",
      badge: "Премиум",
      description:
        "Для участников программы лояльности с уровнем \"Премиум\" предусмотрена скидка 10% на покупку билетов.",
      link: { label: "Подробнее", href: "#tickets" },
    },
    {
      id: "freebet",
      title: "Фрибет 10 000 новым клиентам",
      badge: "От BetBoom",
      description:
        "При первой регистрации в клубе BetBoom, а также на сайте betboom.ru и в приложении по промокоду DRAGONS.",
